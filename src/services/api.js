 ...
 */
export const getAudioUrl = (callSid, type = "") =>
  `${API_BASE_URL}/audio/${callSid}${type}`;
 ...
 * @returns {Promise<object>}
 */
export const simulateUserResponse = (callSid, userInput) =>
  request("/simulate-user-response", {
    method: "POST",
 ...
 * @returns {Promise<object>}
 */
export const updateElevenlabsConfig = (data) =>
  request("/config/elevenlabs", {
    method: "POST",
    body: data,
  });
 ...
 * @returns {Promise<object>}
 */
export const updateTwilioConfig = (data) =>
  request("/config/twilio", {
    method: "POST",
    body: data,
  });
 ...
 * @returns {Promise<object>}
 */
export const updateGeminiConfig = (data) =>
  request("/config/gemini", {
    method: "POST",
    body: data,
  });
 ...
 * @returns {Promise<object>}
 */
export const updateCallScripts = (data) =>
  request("/config/scripts", {
    method: "POST",
    body: data,
  });
...
/**
 * Calls /continue-call endpoint.
 * @param {string} call_sid
 * @param {string} user_input
 * @param {boolean} is_audio
 * @returns {Promise<object>}
 */
...
/**
 * Calls /handle-questions endpoint.
 * @param {string} call_sid
 * @param {string} user_input
 * @param {boolean} is_audio
 * @param {object} conversation_state
 * @returns {Promise<object>}
 */
...
/**
 * Calls /text-to-speech endpoint to generate speech audio.
...
export const textToSpeech = async (text) => {
  ...
  if (!response.ok) {
    const errorData = await response.json();
    throw new Error(errorData.error || "Failed to get speech audio");
  }
